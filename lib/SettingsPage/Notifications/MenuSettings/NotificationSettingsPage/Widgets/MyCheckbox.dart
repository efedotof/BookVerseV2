...
class CheckBoxCustomItemMenu extends StatefulWidget {
  const CheckBoxCustomItemMenu({super.key,
  required this.text,
    ...
    return  Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Container(width: MediaQuery.of(context).size.width * 0.6 ,child: Text(widget.text, maxLines: 3,  style: Theme.of(context).primaryTextTheme.bodyText1)),
    Switch(
                      splashRadius: 50.0,
                      value: isChecked,
                      onChanged: (value) {
