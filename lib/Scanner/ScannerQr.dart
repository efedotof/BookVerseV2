...
import 'package:readerabooks/Scanner/ScannerOutput.dart';
...
class _ScannerQrState extends State<ScannerQr> {
  ...
  List<String> nameSpasingToChat = ['ShowOnScanntoScannerQr'.tr(), 'ScanOnScanntoScannerQr'.tr()];
  ...
  title: Text('TitleOnScanntoScannerQr'.tr(), style:Theme.of(context).primaryTextTheme.bodyText1),
